...
export function isMaxAndInvalid<T extends Record<string, any>>(value: number, obj: T, key: Key<T>, form: NgForm): boolean {
  ...
  if (condition) {
    setError(form, key, {type: 'MAX_ERROR', maxValue: maxValidation.max});
    return true;
  }
